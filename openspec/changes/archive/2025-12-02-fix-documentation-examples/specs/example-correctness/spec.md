...
## Purpose
Documentation code examples must be executable, accurate, and demonstrate real API usage with explicit argument patterns to help users understand available options.
...
- **Extends** `documentation-quality` spec: Examples are part of documentation quality
- **Supports** `documentation-organization` spec: Correct examples support user-facing docs
- **Complements** Python code quality requirements: Examples demonstrate actual API usage